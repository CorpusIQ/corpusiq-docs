...
Every quarterly LP update means collecting data from 20+ portfolio companies, each using different tools.

## How MCP unifies portfolio analytics

Connect each portfolio company's tools. Then ask:

> "What's the aggregate revenue growth across the portfolio this quarter?"
