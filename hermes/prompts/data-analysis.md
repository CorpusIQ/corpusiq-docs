...
Prompt templates for extracting insights from data — reporting, SQL generation, visualization guidance, and metric computation. Replace `[brackets]` with your schema, tools, and questions.
