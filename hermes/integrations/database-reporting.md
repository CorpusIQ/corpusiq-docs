...
A blueprint for connecting databases (PostgreSQL, MySQL, SQL Server, MongoDB) to reporting systems — automated query execution, dashboard generation, anomaly detection, and scheduled report distribution. Covers MCP setup, query management, and cron patterns.
