...
|---|-------|--------|----------|----------|-------------|
| 1 | `reddit-automation` | doany-skills/skills | 112.9K | Marketing & Growth | ✅ |
| 2 | `opentui` | msmps/opentui-skill | 52.8K | Development & Tools | ✅ |
| 3 | `monitoring-expert` | jeffallan/claude-skills | 3.9K | DevOps & Infrastructure | ✅ |
| 4 | `guizang-social-card-skill` | op7418/guizang-social-card-skill | 3.7K | Content & Media | ✅ |
...
| Skill | Publisher | Installs | Reason Skipped |
|-------|-----------|----------|----------------|
| `dbs-content` | dontbesilent2025/dbskill | 17.6K | Chinese-language content diagnosis tool |
