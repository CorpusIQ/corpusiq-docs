...
**Results:** 205 unique skills surfaced, 2 genuinely new (not in any prior sweep or catalog)
...
|---|-------|----------|-----------|----------|
| 1 | openclaw-workspace | 143 | win4r/openclaw-workspace | Workspace Management |
| 2 | pymupdf-pdf | 47 | kesslerio/pymupdf-pdf-parser-clawdbot-skill | Document Processing |
...
PDF parsing and extraction for Clawdbot agents using PyMuPDF. Extract text, tables, and metadata from PDF documents. Companion to `kesslerio/mineru-pdf-parser-clawdbot-skill` (101 installs, already catalogued).

```bash
npx skills add kesslerio/pymupdf-pdf-parser-clawdbot-skill --skill pymupdf-pdf
```
