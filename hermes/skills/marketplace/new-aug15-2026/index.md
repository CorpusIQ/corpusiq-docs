...
**Date:** August 15, 2026
**Result:** 10 new publisher clusters · 88 skills · ~708K combined installs · 10 setup guides

Sweep combined the hot (1H delta) and all-time leaderboards with 40 API queries, cross-referenced 3,944 unique skills against the existing `hermes/skills/` tree. Publisher pages were fetched for authoritative install counts on every drafted cluster. Ten uncovered clusters with substantive Hermes value were guided; the remaining candidates are parked in the queue below, alongside the August 14 evening queue (amazonappdev, lottiefiles, sonilo-ai, emblemcompany, dmmulroy/anti-slop, mintlify/docs, ljagiello/ctf-skills, digitalsamba, getsentry/skills).
...
**Setup guide:** [Academic Research Skills Setup](/hermes/skills/catalog/academic-research-skills-setup/)
...
|---|---|---|---|
| dammyjay93/interface-design | 1 | 23.6K | Interface design workflow |
| feature-sliced/skills | 1 | 16.5K | Feature-sliced design architecture |
| software-mansion/argent | 1 | 11.9K | React Native app workflow |
| worldwonderer/oh-story-claudecode | 1 | 11.4K | browser-cdp skill |
| vuejs-ai/skills | 1 | 10.7K | Vue testing best practices |
| rivet-dev/skills | 1 | 10.1K | sandbox-agent |
| lombiq/tailwind-agent-skills | 1 | 10.1K | Tailwind 4 docs |
| bradautomates/claude-video | 1 | 10.0K | watch (video) |
| 199-biotechnologies/claude-deep-research-skill | 1 | 9.4K | deep research |
| superdesigndev/superdesign-skill | 1 | 8.0K | superdesign |
| cloudai-x/threejs-skills | 1 | 7.9K | threejs geometry |
| kylezantos/design-motion-principles | 1 | 7.8K | design motion principles |
| twostraws/swift-testing-agent-skill | 1 | 7.5K | swift-testing-pro |
| tiangong-ai/skills | 2 | 7.1K | email-smtp-send, email-imap-fetch |
| ceorkm/mobile-app-ui-design | 1 | 6.7K | mobile app UI design |
| rknall/claude-skills | 1 | 6.2K | svg logo designer |

Carry-over queue from prior sweeps (not re-drafted this cycle): amazonappdev/devices-agent-skills, lottiefiles/motion-design-skill, sonilo-ai/skills, emblemcompany/agent-skills, dmmulroy/anti-slop, mintlify/docs, ljagiello/ctf-skills, digitalsamba/claude-code-video-toolkit, getsentry/skills, herdr, last30days, agent-config, stop-slop, web-access, brightdata, langfuse, zhaono1/agent-playbook.
