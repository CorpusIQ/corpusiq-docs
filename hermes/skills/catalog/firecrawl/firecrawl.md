---
name: firecrawl
description: Full web scraping CLI. Turn any website into structured markdown. Core infrastructure for research agents. 70.7K installs.
triggers:
  - "firecrawl"
source: skills.sh marketplace
category: firecrawl
setup: npx skills add firecrawl/cli@firecrawl
---

# Firecrawl

Full web scraping CLI.
...
Scrape websites, extract structured data, handle JavaScript rendering.
