...
category: firecrawl
setup: npx skills add firecrawl/cli@firecrawl-scrape
---

# Firecrawl Scrape

Single-page web extraction.

## Setup

```bash
npx skills add firecrawl/cli@firecrawl-scrape
```

## Capabilities

Extract single page content, clean markdown output, handle dynamic pages.
