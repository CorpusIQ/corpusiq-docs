...
description: Scaffold Stripe projects. Generate complete Stripe integration projects with best practices built in. 31.3K installs.
triggers:
  - "stripe projects"
...
Scaffold Stripe projects.

## Setup

```bash
npx skills add stripe/ai@stripe-projects
```

## Capabilities

Project scaffolding, payment flows, subscription setup, webhook configuration.
