...
**Skills:** 1 skill · 6.7K installs
**Category:** Design / Mobile UI
...
| **Design tool or UI codebase** | Any mobile interface work |

## What It Provides

| Skill | Installs | Purpose |
|---|---|---|
| mobile-app-ui-design | 6.7K | Structured mobile UI/UX design process and principles |

## Quick Start

1. Install: `npx skills add https://github.com/ceorkm/mobile-app-ui-design --skill mobile-app-ui-design`
2. Ask: "design the onboarding screen for my mobile app following your process"
3. Expect the three-question analysis before any visual decisions

## CorpusIQ Use Cases

| Use Case | How |
|---|---|
| **Mobile client work** | Design guidance for mobile app projects |
| **MVP screen design** | Structured process for first-pass screens without a design team |
| **Design review checklist** | The principles double as a critique framework |
| **Agent design capability** | Extends agent-driven UI work from web to mobile |
