...
description: Database schema design and migrations with Prisma. Type-safe database access for TypeScript projects. 11.6K installs.
triggers:
...
Schema design, migrations, seeding, database introspection.
