...
- [Convex Agent Skills — Backend Platform (BaaS) Setup](/docs/hermes/skills/catalog/convex-agent-skills-setup.html)
- [Emil Kowalski Skills — Design Engineering Suite Setup](/docs/hermes/skills/catalog/emilkowalski-skills-setup.html)
- [UI/UX Pro Max — Design System Skill Pack Setup](/docs/hermes/skills/catalog/ui-ux-pro-max-setup.html)
- [Higgsfield Skills — AI Video & Image Generation Cluster Setup](/docs/hermes/skills/catalog/higgsfield-skills-setup.html)
- [OSINT Skills — Open-Source Intelligence Suite Setup](/docs/hermes/skills/catalog/osint-skills-setup.html)
- [Wind Skills — Financial Terminal Research Cluster Setup](/docs/hermes/skills/catalog/wind-skills-setup.html)
- [Momentic Skills — AI QA Testing Suite Setup](/docs/hermes/skills/catalog/momentic-skills-setup.html)
- [Planning With Files — Agent Planning Methodology Setup](/docs/hermes/skills/catalog/planning-with-files-setup.html)
- [Wonda CLI — Terminal AI Content Creation Setup](/docs/hermes/skills/catalog/wonda-setup.html)
- [SquirrelScan Skills — Website Audit Tool Setup](/docs/hermes/skills/catalog/squirrelscan-skills-setup.html)
- [Solana Dev Skill — Blockchain Development Setup](/docs/hermes/skills/catalog/solana-dev-skill-setup.html)
- [Genkit Skills — Firebase Genkit AI Framework Setup](/docs/hermes/skills/catalog/genkit-skills-setup.html)
