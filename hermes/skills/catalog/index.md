...
- [OpenClaw Backup — Encrypted Agent Workspace Backup Setup](/docs/hermes/skills/catalog/openclaw-backup-setup.html)
...
- [Skill Vetter — Security Audit for Hermes Skills Setup](/docs/hermes/skills/catalog/skill-vetter-setup.html)
