...
**Skills:** 1 skill (`huashu-design`) · 42.9K installs
...
| **Brand assets** | Logo, product imagery, and UI screenshots before color work |
| **No backend needed** | Outputs are static HTML prototypes, decks, and animations |

## What It Provides

| Capability | Notes |
|---|---|
| Specialist roles | Embodies animator, UX designer, slide designer, or prototyper per task |
| Prototypes | High-fidelity interactive product mockups |
| Design variants | Three differentiated directions when context is unclear |
| Slide decks | 1920×1080 HTML decks usable as presentations with keyboard navigation |
| Animations | Timeline-driven motion design with synchronized recording mode |
| Video pipelines | Narration-driven long-form video from HTML sequences |
| Checkpoints | User confirmation at four stages before full implementation |

## Quick Start

1. `npx skills add alchaincyf/huashu-design`
2. Provide brand assets first: "design a landing page prototype; here is the logo and product screenshot"
3. Review the three proposed directions, pick one, and confirm at each checkpoint

## CorpusIQ Use Cases

| Use Case | How |
|---|---|
| **Landing page concepts** | Interactive HTML prototypes before committing to production design |
| **Investor decks** | 1920×1080 HTML decks with keyboard navigation |
| **Product mockups** | iOS/Android starter components for feature visualizations |
| **Motion design** | Animation demos as video material for social channels |
