...
description: Audit Firestore security rules. Analyze and harden Firestore security configurations. 41.7K installs.
triggers:
...
Rule analysis, vulnerability detection, access pattern recommendations.
