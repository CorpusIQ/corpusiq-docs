...
**This sweep:** 30 new servers (6 high-value guides created)
...
| **FTP MCP** ★★ | File Transfer | FTP/SFTP operations through MCP. |
| **Santiment** ★★ | Finance/Crypto | Crypto market data, on-chain metrics, social trends for 2,000+ assets. |
| **Google Image MCP** ★ | Search | Google Image Search through MCP. |
| **Grok Chat MCP** ★ | AI | Grok chat interface through MCP (by codechap). |
| **Claude Chat MCP** ★ | AI | Claude chat interface through MCP (by codechap). |
| **GPT Chat MCP** ★ | AI | GPT chat interface through MCP (by codechap). |

## Full Discovery List (30 Servers)

| # | Server | Category | Source | Guide Created |
|---|--------|----------|--------|---------------|
| 1 | Outside Agent | AI/Tools | mcpservers.org | ❌ |
| 2 | Fixou | Dev Tools | mcpservers.org | ❌ |
| 3 | Argus Testing | Testing | mcpservers.org | ❌ |
| 4 | KoreanAds | Advertising | mcpservers.org | ❌ |
| 5 | BBW Belles Formalwear Evidence | Niche | mcpservers.org | ❌ |
| 6 | Confluence to Markdown MCP | Docs | mcpservers.org | ❌ |
| 7 | FeatureBoard | Product | mcpservers.org | ❌ |
| 8 | Routara LLM Gateway | Dev Tools | mcpservers.org | ❌ |
| 9 | AI Consensus | Research | mcpservers.org | ❌ |
| 10 | BountyVerdict | Security | mcpservers.org | ❌ |
| 11 | KPI Depot | Business Intel | mcpservers.org | ✅ |
| 12 | AIQUAA Playwright MCP | Testing | mcpservers.org | ❌ |
| 13 | Retasc | Unknown | mcpservers.org | ❌ |
| 14 | Index One | Search | mcpservers.org | ❌ |
| 15 | BuiltWith | Competitive Intel | mcpservers.org | ✅ |
| 16 | Actvt | macOS | mcpservers.org | ❌ |
| 17 | Grok Chat MCP | AI Chat | mcpservers.org | ❌ |
| 18 | 1ClickReport | Marketing Analytics | mcpservers.org | ✅ |
| 19 | Agent Browser MCP | Browser | mcpservers.org | ❌ |
| 20 | Santiment | Finance/Crypto | mcpservers.org | ❌ |
| 21 | Snipara | Unknown | mcpservers.org | ❌ |
| 22 | Peil-mcp | Unknown | mcpservers.org | ❌ |
| 23 | Fable MCP | AI Chat | mcpservers.org | ❌ |
| 24 | Claude Chat MCP | AI Chat | mcpservers.org | ❌ |
| 25 | FreshBooks MCP | Accounting | mcpservers.org | ✅ |
| 26 | Google Image MCP | Search | mcpservers.org | ❌ |
| 27 | Google Ads MCP | Advertising | mcpservers.org | ✅ |
| 28 | Google Analytics MCP | Analytics | mcpservers.org | ✅ |
| 29 | FTP MCP | File Transfer | mcpservers.org | ❌ |
| 30 | GPT Chat MCP | AI Chat | mcpservers.org | ❌ |
...
- [[servers/external/freshbooks-mcp]]
- [[servers/external/google-ads-mcp]]
- [[servers/external/google-analytics-mcp]]
- [[servers/external/builtwith-mcp]]
- [[servers/external/kpidepot-mcp]]
- [[servers/external/1clickreport-mcp]]
