...
finds: 10
guides: 0
canonical: "https://www.corpusiq.io/docs/hermes/mcp/sweeps/sweep-august13-2026-morning/"
robots: "index,follow"
last_updated: "2026-08-13"
tags: ["mcp server", "model context protocol", "hermes mcp", "social publishing", "seo"]
...
- **10 new business-relevant finds** since the August 11 evening sweep
- **Social publishing is the fastest-moving category**: 13+ MCP tools now (up from 8 on Aug 10)
- **SEO category growing**: LLMScout (45+ tools), TimeToPost (GEO platform), Misar Blog, Glippy, AI Slop Checker
- **Agent governance maturing**: Mission Control at 5.4K stars, Microsoft AGT at 5.6K stars
- **Hermes milestone tracked**: 228K+ GitHub stars, Skills Hub 90K+
...
**Why it matters:** The widest platform coverage of any social MCP observed. The human approval gate is the right design for autonomous use. Evaluate pricing before adopting.

- Repo: github.com/Rohan27s/posthell-mcp
...
**Why it matters:** Direct hit on the SEO gap. One MCP covering keyword research through article publishing.
...
**Why it matters:** The governance layer every multi-agent shop eventually needs. Self-hosted and free.
...
**Why it matters:** Turns six outreach dashboards into one queryable source. The backbone for agentic cold outreach.
...
- URL: mcpservers.org/servers/timetopost-co
...
### Social Publishing (exploding)

| Tool | Platforms | Publish | Hermes Compatible |
|------|-----------|---------|-------------------|
| PostHell | 15 | Yes | Via MCP |
| bundle.social | 14+ | Yes | Via MCP |
| Tofu Bofu | 12 | Yes | Via MCP |
| Publora | 10 | Yes | Via MCP |
| Taisly | 5 (video) | Yes | Via MCP |
| Blotato | 8+ | Yes | Tested |
| Postiz | 30+ | Yes | In use |

The winner will be decided by reliability, platform coverage, human-approval gates, and pricing. PostHell leads on coverage. Blotato leads on proven reliability. Postiz stays as the reliable default.

### SEO & GEO (growing fast)

LLMScout + Google Search Console MCP for free tier work. TimeToPost for GEO tracking. The coreyhaines31/ai-seo skill for best practices.

### Agent Governance (maturing)

Mission Control for fleet management. Microsoft AGT for runtime policy enforcement. cordum for action firewalls. SkillClaw (2.3K stars) for collective skill evolution.

## Verdicts

- **EVALUATE NOW:** PostHell (if pricing reasonable), LLMScout (free tier test)
- **INSTALL:** drawio-skill (free, Hermes-compatible, 5.8K stars)
- **MONITOR:** Taisly (video scale-up), Publora, TimeToPost (GEO), GrowChief
