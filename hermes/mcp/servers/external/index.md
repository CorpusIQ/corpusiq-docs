...
- [AI Footprints MCP — Agent-First Bookmark & Knowledge Manager](/docs/hermes/mcp/servers/external/ai-footprints-mcp/index.html)
- [Bug Bounty Intelligence MCP — Smart Contract Security Analysis](/docs/hermes/mcp/servers/external/bug-bounty-intelligence-mcp/index.html)
- [Charming MCP — Generate & Host Interactive Web Apps via AI Agents](/docs/hermes/mcp/servers/external/charming-mcp/index.html)
- [Confluence2MD MCP — Confluence to Markdown Converter for AI Agents](/docs/hermes/mcp/servers/external/confluence2md-mcp/index.html)
- [FeatureBoard MCP — Feature Flag Management for AI Agents](/docs/hermes/mcp/servers/external/featureboard-mcp/index.html)
- [FT Optix MCP — FactoryTalk Optix Integration](/docs/hermes/mcp/servers/external/ft-optix-mcp/index.html)
- [Gainium MCP — AI-Powered Crypto Trading Automation](/docs/hermes/mcp/servers/external/gainium-mcp/index.html)
- [Goalie Trademark Search MCP — IP Clearance for AI Agents](/docs/hermes/mcp/servers/external/goalie-trademark-search-mcp/index.html)
- [Moxie Docs MCP — Documentation Intelligence for AI Agents](/docs/hermes/mcp/servers/external/moxie-docs-mcp/index.html)
- [Nexly Analytics MCP — Integration Guide](/docs/hermes/mcp/servers/external/nexly-mcp/index.html)
- [Outside Agent MCP — External Tool Orchestration](/docs/hermes/mcp/servers/external/outside-agent-mcp/index.html)
- [PLUR MCP — Persistent Memory for AI Agents](/docs/hermes/mcp/servers/external/plur-mcp/index.html)
- [Reelier MCP — Video Content Intelligence for AI Agents](/docs/hermes/mcp/servers/external/reelier-mcp/index.html)
- [Routara LLM Gateway MCP — Multi-Provider LLM Routing](/docs/hermes/mcp/servers/external/routara-llm-gateway-mcp/index.html)
