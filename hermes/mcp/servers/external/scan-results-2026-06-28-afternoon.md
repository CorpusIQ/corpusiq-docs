...
## SOURCE: mcp.so Feed (past 24 hours)
...
## NEW BUSINESS-RELEVANT SERVERS (Priority)

### 1. SIXTA Connect ★ New
- **Category:** Analytics / Database
- DBRE-grade SQL analysis inside any MCP client. No connection, no install required.
- Paste a query, EXPLAIN plan, migration, or error → get named findings with severity, rationale, and ready-to-run fixes for PostgreSQL and MySQL
- No auth required (paste-based)
- Business relevance: Database optimization for operators running PostgreSQL/MySQL. Instant SQL review without connecting to production.
...
- Social media content planning and publishing for AI agents
- Business relevance: Social media content strategy and automation for marketing operators.

### 6. Catchintent ★ New
- **Category:** Marketing / Sales
- Intent catching and lead identification for AI agents
- Business relevance: Lead generation and sales intelligence for operators.

### 7. Datahyena ★ New
- **Category:** Analytics / Data
- Data analysis and processing for AI agents
- Business relevance: Data operations and analytics for business operators.

### 8. Edata4you ★ New
- **Category:** Analytics / Data
- Data service platform for AI agents
- Business relevance: Data access and processing for operators.
...
### 12. SVGFarm ★ New
- Search open SVG icon packs and fetch exact SVG markup from coding agents
...
- Blockchain context provider for AI agents
...
- Graph-based data visualization and analysis for AI agents
- Niche: Data visualization operators

### 18. Fuse Network ★ New
- Blockchain network integration for AI agents
- Niche: Web3 operators
...
- Added 18 new servers to `index.md` catalog
- Created integration guides for: SIXTA Connect, Opencloudcosts, Aikount
- Updated "last updated" timestamp to June 28, 2026 (afternoon sweep)
- Pushed to GitHub
...
| Source | New Found Today | Added to Catalog | Integration Guides |
|--------|----------------|-----------------|-------------------|
| mcp.so Feed | 18 | 18 | 3 |
...
- **AI search ecosystem**: AI Tool Directory and AEO Tool show the meta-layer around AI discoverability growing
