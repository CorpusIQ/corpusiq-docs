...
- **Competitive intelligence:** See where competitors are advertising

The key differentiator: you get the actual buyer's name and email, not just the brand name. This turns research into actionable outreach.

## Integration with CorpusIQ

Pair with CorpusIQ's CRM connectors (HubSpot, Salesforce) to enrich lead records with podcast sponsorship data. Combine with email connectors for direct outreach to identified buyers. Turn sponsorship intelligence into CRM-qualified leads automatically.

## Limitations

- Exact GitHub repo TBD (GitHub search API rate-limited as of July 14)
- Data is US/English-language focused (podcast ecosystem bias)
- Buyer contact accuracy depends on detection methodology
- May require attribution verification before outreach
