...
```
Server type: Remote
Auth: Account-based (OAuth assumed)
Endpoint: viewmade.com (specific MCP endpoint TBD)
Pricing: Credit-based (production); research access details TBD
Category: Marketing / Content / Video Production
```
...
⚠️ **Early-stage.** ViewMade is listed on mcpservers.org but the public documentation is support-oriented rather than developer-focused. The specific MCP endpoint, authentication flow, and tool descriptions are not publicly documented beyond the mcpservers.org listing. This guide will be updated when detailed MCP integration docs become available.
...
- **Content research:** "What YouTube videos are trending in [niche] this week?"
- **SEO optimization:** "Optimize this video title and description for YouTube search"
- **Video production:** "Produce a 5-minute product walkthrough from this script"
- **Competitive analysis:** "What video formats are my competitors using on YouTube?"
...
- [ViewMade Support](https://viewmade.com/support)
- mcpservers.org listing: `https://mcpservers.org/servers/viewmade-com-support`
