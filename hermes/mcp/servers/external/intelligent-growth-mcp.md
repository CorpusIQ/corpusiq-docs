...
**Category:** Marketing
**Author:** freewillythe4th (community)
**Repo:** github.com/freewillythe4th/intelligent-growth-mcp-public

## Key Features
- **Positioning Analysis:** Generate positioning statements, value propositions, and differentiation frameworks for products
...
- Generate positioning alternatives when pivoting product strategy
- Create launch messaging for new features or product releases
- Validate market assumptions with structured competitive intelligence
- Streamline go-to-market planning for lean teams without dedicated product marketing

## Integration with CorpusIQ

Intelligent Growth MCP complements CorpusIQ's operational data with strategic marketing intelligence:

```
Intelligent Growth → Competitive analysis and positioning
CorpusIQ Analytics → Validate positioning with actual market data (GA4, Ahrefs, SEMrush)
CorpusIQ CRM → Target positioning against actual customer segments (HubSpot)
CorpusIQ Social → Execute positioning through scheduled content (Postiz)
```
