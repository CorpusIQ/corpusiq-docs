...
**Category:** Finance
**Author:** JesusRS1 (community)
**Repo:** github.com/JesusRS1/stock-trade-finance-api
**Stars:** 91 ⭐

## Key Features
- **Stock Prices:** Real-time and historical prices for US equities via Tiingo
- **Forex Rates:** Currency exchange rates and historical forex data
- **Financial News:** Curated financial news feed tied to specific tickers
- **Company Fundamentals:** Financial statements, ratios, and fundamental data
- **MCP-Native:** Built specifically as an MCP server for AI agent consumption
...
Stock Trade Finance MCP adds market data to CorpusIQ's financial operations suite:

```
Stock Trade MCP → Real-time market data and news
CorpusIQ QuickBooks → Compare portfolio performance against business financials
CorpusIQ Stripe → Monitor revenue in context of market conditions
CorpusIQ Analytics → Track market trends alongside website traffic patterns
```
