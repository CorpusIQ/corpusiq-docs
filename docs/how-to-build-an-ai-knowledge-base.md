...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How is this different from a wiki or Confluence?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Wikis require manual updates and navigation. An AI knowledge base answers questions directly from live data \u2014 no browsing, no stale pages."
      }
    },
    {
      "@type": "Question",
      "name": "Can it handle confidential information?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. CorpusIQ inherits the permissions of each connected source. Users only see what they're authorized to access."
      }
    },
    {
      "@type": "Question",
      "name": "What if the AI gives a wrong answer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Accuracy depends on your source data. Keep your policies and data up to date, and refine questions for clarity. The AI is only as accurate as the data it queries."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Connect your existing sources \u2014 wikis, drives, CRMs \u2014 and the AI queries them live. No migration needed."
      }
    },
    {
      "@type": "Question",
      "name": "Can I restrict certain data from the knowledge base?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CorpusIQ inherits permissions from source systems. If a user can't access a file in Drive, the AI can't retrieve it for them either."
      }
    },
    {
      "@type": "Question",
      "name": "How do I add new knowledge?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Add it to your existing tools normally \u2014 update the wiki, add a doc to Drive, update the CRM. The AI picks up changes immediately since it queries live sources."
      }
    },
    {
      "@type": "Question",
      "name": "Can this replace our internal wiki?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes \u2014 for question-answering. You may still want a wiki for browseable, structured documentation. The AI knowledge base complements rather than fully replaces traditional wikis."
      }
    }
  ]
}
