...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Do I need ChatGPT Plus to use CorpusIQ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "ChatGPT Plus, Team, or Enterprise with MCP support is recommended. The free tier has limited MCP capabilities."
      }
    },
    {
      "@type": "Question",
      "name": "Is uploading CSVs really that bad?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For one-off questions, it works. For ongoing business intelligence, it's inefficient, insecure, and produces stale answers."
      }
    },
    {
      "@type": "Question",
      "name": "What about Claude?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CorpusIQ works with any MCP-compatible AI assistant, including Claude, not just ChatGPT."
      }
    },
    {
      "@type": "Question",
      "name": "How secure is the MCP connection?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CorpusIQ uses OAuth 2.0, read-only access, and never stores your data. It's more secure than exporting data to CSV files."
      }
    },
    {
      "@type": "Question",
      "name": "Can I connect multiple ChatGPT accounts to the same data?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Each user should have their own CorpusIQ account connected to their own data sources, ensuring proper permission inheritance."
      }
    },
    {
      "@type": "Question",
      "name": "What happens when my data changes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CorpusIQ queries live APIs on every request. Changes in HubSpot or QuickBooks are reflected immediately."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "CorpusIQ offers a free tier. The free tier of ChatGPT has limited MCP support \u2014 a paid plan is recommended for full functionality."
      }
    }
  ]
}
