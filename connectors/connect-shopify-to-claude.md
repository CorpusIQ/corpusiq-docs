...
- "Show me orders that haven't shipped in over 3 days."
- "Which customers spent over $500 total this year?"

You get answers in seconds. No dashboard. No report. Just ask.

## What CorpusIQ connects from Shopify

- Orders (status, revenue, fulfillment, customer)
- Products and variants (inventory, pricing, SKUs)
- Customers (lifetime value, order history, location)
- Refunds and returns
- Collections

Read-only. CorpusIQ never modifies your store.

## How to connect Shopify to Claude in 2 minutes
